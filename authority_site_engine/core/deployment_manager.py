...
def resolve_wordpress_connection(project: ProjectData) -> tuple[str, str, str]:
...
class DeploymentManager:
    ...
    def _build_client(self) -> WordPressRestClient:
        site_url, username, password = resolve_wordpress_connection(self.project)
        return WordPressRestClient(site_url, username, password, logger=self.logger)
